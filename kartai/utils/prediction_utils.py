...
def get_raster_predictions_dir(area_name, checkpoint_name):
    raster_output_dir = os.path.join(env.get_env_variable(
        "prediction_results_directory"), area_name, checkpoint_name, "rasters")
...
def get_vector_predictions_dir(area_name, checkpoint_name):
    vector_output_dir = os.path.join(env.get_env_variable(
        "prediction_results_directory"), area_name, checkpoint_name, "vector")
